    ...
    <div className="min-h-screen relative overflow-hidden bg-slate-50">
      ...
      {showModal && selectedTicket && (
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-slate-200/60 flex justify-between items-start">
              <div>
            ...
            <div className="p-8 space-y-8">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed bg-white/50 p-4 rounded-xl border border-white/50">{selectedTicket.description}</p>
              </div>
